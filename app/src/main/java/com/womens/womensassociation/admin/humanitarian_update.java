...
public class humanitarian_update extends Fragment {
    ImageView imageView;
    EditText describe;
    Button uplode;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_humanitarian_update, container, false);
    }
    ...
    void intialviews() {
        imageView = view.findViewById(R.id.uplode_image_hum);
        describe = view.findViewById(R.id.describe_hum);
        uplode = view.findViewById(R.id.uplod_hum);
    ...
    void uploadtodatabase(String image_url, final String describee) {
        ...
        FirebaseDatabase.getInstance().getReference().child("pageone")
                .child("humanitarian").setValue(aboutUsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    void getdata() {
        FirebaseDatabase.getInstance().getReference().child("pageone").child("humanitarian").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
