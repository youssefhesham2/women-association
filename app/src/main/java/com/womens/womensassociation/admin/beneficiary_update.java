...
public class beneficiary_update extends Fragment {
    ImageView imageView;
    EditText describe;
    Button uplode;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_beneficiary_update, container, false);
    }
    ...
    void intialviews() {
        imageView = view.findViewById(R.id.uplode_image_beneficiary);
        describe = view.findViewById(R.id.describe_beneficiary);
        uplode = view.findViewById(R.id.uplodaboutus_beneficiary);
    ...
    void uploadtodatabase(String image_url, final String describee) {
        ...
        FirebaseDatabase.getInstance().getReference().child("pageone")
                .child("beneficiary").setValue(aboutUsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
