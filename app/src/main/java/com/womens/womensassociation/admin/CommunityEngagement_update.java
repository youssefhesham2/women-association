...
public class CommunityEngagement_update extends Fragment {
    ImageView imageView;
    EditText describe;
    Button uplode;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_community_engagement_update, container, false);
    }
    ...
    void intialviews() {
        imageView = view.findViewById(R.id.uplode_image_comm);
        imageView.setImageResource(R.drawable.ic_menu_camera);
        describe = view.findViewById(R.id.describe_comm);
        uplode = view.findViewById(R.id.uplod_comm);
    ...
    void uploadtodatabase(String image_url, final String describee) {
        ...
        FirebaseDatabase.getInstance().getReference().child("pageone")
                .child("community engagement").setValue(aboutUsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    void getdata() {
        FirebaseDatabase.getInstance().getReference().child("pageone").child("community engagement").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
