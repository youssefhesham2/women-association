...
public class widows_update extends Fragment {
    ImageView imageView;
    EditText describe;
    Button uplode;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_widows_update, container, false);
    }
    ...
    void intialviews() {
        imageView = view.findViewById(R.id.uplode_image_widow);
        describe = view.findViewById(R.id.describe_widow);
        uplode = view.findViewById(R.id.uplod_widows);
    ...
    void uploadtodatabase(String image_url, final String describee) {
        ...
        FirebaseDatabase.getInstance().getReference().child("pageone")
                .child("widows and orphans").setValue(aboutUsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    void getdata() {
        FirebaseDatabase.getInstance().getReference().child("pageone").child("widows and orphans").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
