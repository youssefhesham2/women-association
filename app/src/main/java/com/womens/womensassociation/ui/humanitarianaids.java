package com.womens.womensassociation.ui;
...
public class humanitarianaids extends Fragment {
    View view;
    ImageView imageView;
    TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_humanitarianaids, container, false);
    }
    ...
    private void intialview() {
        imageView = view.findViewById(R.id.image__hum);
        textView = view.findViewById(R.id.text_hum);
    }
