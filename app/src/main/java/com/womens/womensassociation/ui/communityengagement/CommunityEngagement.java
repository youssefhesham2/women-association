package com.womens.womensassociation.ui.communityengagement;
...
public class CommunityEngagement extends Fragment {
    View view;
    ImageView imageView;
    TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_community_engagement, container, false);
    }
    ...
    private void intialview() {
        imageView = view.findViewById(R.id.image__comm);
        textView = view.findViewById(R.id.text_comm);
    }
