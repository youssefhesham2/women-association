package com.womens.womensassociation.ui.widowsandorphans;
...
public class WidowsAndOrphans extends Fragment {
    View view;
    ImageView imageView;
    TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_widows_and_orphans, container, false);
    }
    ...
    private void intialview() {
        imageView = view.findViewById(R.id.image__widows);
        textView = view.findViewById(R.id.text_widows);
    }
